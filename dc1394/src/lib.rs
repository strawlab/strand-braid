...
pub enum Error {
    ...
    DC1394Error { code: ffi::dc1394error_t::Type },
...
impl Camera {
    ...
    pub fn image_position(&self) -> Result<(u32, u32)> {
            ...
            == ffi::dc1394bool_t::DC1394_TRUE
        {
            let mut left = 0u32;
            let mut top = 0u32;
            dc1394_try!(ffi::dc1394_format7_get_image_position(
                self.ptr, video_mode, &mut left, &mut top
            ));
            Ok((left, top))
        } else {
            Ok((0, 0))
    ...
    pub fn set_roi(&self, left: u32, top: u32, width: u32, height: u32) -> Result<()> {
        ...
        dc1394_try!(ffi::dc1394_format7_get_packet_size(
            self.ptr,
            video_mode,
            &mut packet_size
        ));
        dc1394_try!(ffi::dc1394_format7_set_roi(
            self.ptr,
            video_mode,
            coding,
            packet_size as i32,
    ...
    pub fn image_size(&self) -> Result<(u32, u32)> {
            ...
            == ffi::dc1394bool_t::DC1394_TRUE
        {
            let mut w = 0u32;
            let mut h = 0u32;
            dc1394_try!(ffi::dc1394_format7_get_image_size(
                self.ptr, video_mode, &mut w, &mut h
            ));
            Ok((w, h))
        } else {
            let mut w = 0u32;
            let mut h = 0u32;
            dc1394_try!(ffi::dc1394_get_image_size_from_video_mode(
                self.ptr, video_mode, &mut w, &mut h
            ));
            Ok((w, h))
        }
    ...
    pub fn max_image_size(&self) -> Result<(u32, u32)> {
            ...
            == ffi::dc1394bool_t::DC1394_TRUE
        {
            let mut w = 0u32;
            let mut h = 0u32;
            dc1394_try!(ffi::dc1394_format7_get_max_image_size(
                self.ptr, video_mode, &mut w, &mut h
            ));
            Ok((w, h))
        } else {
    ...
    pub fn color_coding(&self) -> Result<ffi::dc1394color_coding_t::Type> {
        ...
        if unsafe { ffi::dc1394_is_video_mode_scalable(video_mode) }
            == ffi::dc1394bool_t::DC1394_TRUE
        {
            dc1394_try!(ffi::dc1394_format7_get_color_coding(
                self.ptr,
                video_mode,
                &mut coding
            ));
        } else {
            dc1394_try!(ffi::dc1394_get_color_coding_from_video_mode(
                self.ptr,
                video_mode,
                &mut coding
            ));
    ...
    pub fn set_color_coding(&self, coding: ffi::dc1394color_coding_t::Type) -> Result<()> {
        ...
        if unsafe { ffi::dc1394_is_video_mode_scalable(video_mode) }
            == ffi::dc1394bool_t::DC1394_TRUE
        {
            dc1394_try!(ffi::dc1394_format7_set_color_coding(
                self.ptr, video_mode, coding
            ));
        } else {
            return Err(Error::RequiresFormat7Mode);
        }
    ...
    pub fn color_filter(&self) -> Result<ffi::dc1394color_filter_t::Type> {
        ...
        if unsafe { ffi::dc1394_is_video_mode_scalable(video_mode) }
            == ffi::dc1394bool_t::DC1394_TRUE
        {
            dc1394_try!(ffi::dc1394_format7_get_color_filter(
                self.ptr,
                video_mode,
                &mut filter
            ));
    ...
    pub fn possible_color_codings(&self) -> Result<Vec<ffi::dc1394color_coding_t::Type>> {
            ...
            == ffi::dc1394bool_t::DC1394_TRUE
        {
            ...
            dc1394_try!(ffi::dc1394_format7_get_color_codings(
                self.ptr,
                video_mode,
                &mut codings
            ));
    ...
    */
    ...
    pub fn exposure_time(&self) -> Result<f64> {
        ...
        dc1394_try!(ffi::dc1394_feature_get_value(
            self.ptr,
            ffi::dc1394feature_t::DC1394_FEATURE_SHUTTER,
            &mut result
        ));
        Ok(result as f64)
    }
    pub fn exposure_time_range(&self) -> Result<(f64, f64)> {
        let mut min: u32 = 0;
        let mut max: u32 = 0;
        dc1394_try!(ffi::dc1394_feature_get_boundaries(
            self.ptr,
            ffi::dc1394feature_t::DC1394_FEATURE_SHUTTER,
            &mut min,
            &mut max
    ...
    pub fn set_exposure_time(&mut self, value: f64) -> Result<()> {
        let v2 = value as u32;
        dc1394_try!(ffi::dc1394_feature_set_value(
            self.ptr,
            ffi::dc1394feature_t::DC1394_FEATURE_SHUTTER,
            v2
        ));
    ...
    pub fn exposure_auto(&self) -> Result<ExposureAuto> {
        ...
        dc1394_try!(ffi::dc1394_feature_get_mode(
            self.ptr,
            ffi::dc1394feature_t::DC1394_FEATURE_SHUTTER,
            &mut mode
        ));
    ...
    pub fn set_exposure_auto(&mut self, value: ExposureAuto) -> Result<()> {
        ...
        dc1394_try!(ffi::dc1394_feature_set_mode(
            self.ptr,
            ffi::dc1394feature_t::DC1394_FEATURE_SHUTTER,
            v2
        ));
    ...
    pub fn trigger_mode(&self) -> Result<TriggerMode> {
        ...
        dc1394_try!(ffi::dc1394_feature_get_power(
            self.ptr,
    ...
    pub fn capture_setup(&self, num_buffers: u32) -> Result<()> {
        dc1394_try!(ffi::dc1394_capture_setup(
            self.ptr,
            num_buffers,
...
impl<'a> Frame<'a> {
    fn capture<'b>(
        cam: &'a Camera,
        policy: &'b ffi::dc1394capture_policy_t::Type,
    ) -> Result<Frame<'a>> {
...
impl<'a> Drop for Frame<'a> {
    fn drop(&mut self) {
        ...
        match unsafe {
            ffi::dc1394_capture_enqueue(self.cam.ptr, self.ptr as *mut ffi::dc1394video_frame_t)
        } {
            ffi::dc1394error_t::DC1394_SUCCESS => {
