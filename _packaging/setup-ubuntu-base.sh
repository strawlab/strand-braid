...
apt-get update
DEBIAN_FRONTEND=noninteractive apt-get install -y cpio libudev-dev zlib1g-dev pkg-config curl build-essential git clang libclang-dev dpkg-dev debhelper zip llvm-dev
