...
if [[ $ARCH == x86_64 ]]; then
    ...
    DEBIAN_FRONTEND=noninteractive apt-get install -y /tmp/pylon_7.3.0.27189-deb0_amd64.deb
    ...
    DEBIAN_FRONTEND=noninteractive apt-get install -y /tmp/pylon_6.2.0.21487-deb0_arm64.deb
else
