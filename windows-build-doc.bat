@REM set RUSTDOCFLAGS="--enable-index-page -Zunstable-options"
...
@REM cargo build --no-default-features --features bundle_files,backend_pyloncxx,ipp-sys/2019,ci2-pyloncxx/backtrace,backtrace --release
