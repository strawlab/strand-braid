...
NUM_JOBS=2 \
cargo build --features "strand-cam/flydra_feat_detect strand-cam/use_ipp strand-cam/imtrack-absdiff strand-cam/bundle_files ipp-sys/2019 strand-cam/checkercal strand-cam/fiducial" --release
