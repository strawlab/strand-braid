...
cargo build --no-default-features --features bundle_files,backend_pyloncxx,flydratrax,with_camtrig,ipp-sys/2019,imtrack-absdiff,image_tracker,cfg-pt-detect-src-prefs,checkercal --release
