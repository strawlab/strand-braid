...
cargo build --features "strand-cam/bundle_files strand-cam/flydra-feat-detect strand-cam/imtrack-absdiff ipp-sys/2019 strand-cam/checkercal backtrace imops/simd" --release
